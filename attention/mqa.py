# description: Multi-Query Attention implementation in PyTorch
import torch
...
class MultiQueryAttention(nn.Module):
    ...
    def forward(self, hidden_states, causal_mask=None, padding_mask=None):
        ...
        # (batch_size, seq_len, hidden_size) * (hidden_size, head_dim) = (batch_size, seq_len, head_dim) 
        ...
        # Reshape key and value to (batch_size, 1, seq_len, head_dim)
